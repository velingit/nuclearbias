...
data = pd.read_csv('france_energy_data.csv')
...
plt.title('France: Electricity Prices, Nuclear & Renewable Generation (Annual 2007-2025)', 
...
xticks = range(0, len(data), 1)  # Every year
...
plt.savefig('france_energy_analysis.png', dpi=300, bbox_inches='tight')
print("✓ Plot saved as: france_energy_analysis.png")
print("\nVisualization shows:")
...
print(f"  • Combined price (NRG_SUP + NETC) annual duplicated to semiannual")
